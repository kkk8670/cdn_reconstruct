<template>
  <div v-loading="loading" class="wx-login-code">
    ...
    <el-divider content-position="center" v-if="!hideDivider"
...
<script>
// API，用户登录注册
import { wxcode, listenWxcode } from '@/v2/cdn_users/api/login'
// 绑定微信
  ...
  methods: {
    ...
    async getWxloginCode() {
      ...
      if (this.routerUrl !== '') {
        ...
        console.log(this.$route.path, this.routerUrl)
      }

      console.log(rUrl, '----', this.$route.path)
