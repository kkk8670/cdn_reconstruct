  ...
  <div class="reg-bind-box">
    ...
    >
      ...
      <el-form-item>
        ...
        <span class="cursor-color" @click="showAgreementDialog"
...
<script>
import { wxbind, wxnew, setPassword } from '@/v2/cdn_users/api/login'
...
export default {
  ...
  methods: {
    ...
    showAgreementDialog() {
      this.$refs.AgreementDialogRef.getAgreementData()
    }
  }
}
</script>
