...
// 根据输入数据推送数据，waf、节点、站点都可以用
export function pushByInputInfo(data) {
    return $http({
        url: 'app/site/pushByInputInfo',
        method: 'post',
        data
    })
}
...
export function pushSiteConfToNode(params) {
    return $http({
        url: 'app/site/pushSiteConfToNode',
        method: 'get',
        params
    })
}
...
export function queryPushDetail(params) {
    return $http({
        url: 'app/site/push/feedbacks/detail',
        method: 'get',
        params
    })
}
