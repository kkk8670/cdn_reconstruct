...
export function getReceiveList(data) {
  return $http({
    url: 'sys/dns/share/rdata/receive/list',
    method: 'post',
    data
  })
}
...
export function addReceiveRdata(params) {
  return $http({
    url: 'sys/dns/share/rdata/receive/add',
    method: 'get',
    params
  })
}
...
export function deleteReceiveRdata(data) {
  return $http({
    url: 'sys/dns/share/rdata/receive/delete',
    method: 'post',
    data
  })
}
...
export function getOutList(data) {
  return $http({
    url: 'sys/dns/share/rdata/out/list',
    method: 'post',
    data
  })
}
...
export function addOutRdata(data) {
  return $http({
    url: 'sys/dns/share/rdata/out/save',
    method: 'post',
    data
  })
}
...
export function deleteOutRdata(data) {
  return $http({
    url: 'sys/dns/share/rdata/out/delete',
    method: 'post',
    data
  })
}
