...
export function batckDomainUpdate(data) {
  return $http({
    url: 'app/dns/batch/update/record',
    method: 'post',
    data
  })
}
...
export function batchMultidomainRecords(data) {
  return $http({
    url: 'app/dns/batch/multidomain/record/set',
    method: 'post',
    data
  })
}
...
export function batchCreateRecords(domain, file) {
  return $http({
    url: `app/dns/batch/import/records/set?domain=${domain}`,
    method: 'post',
    data: file,
...
export function getBatchLogList(data) {
  return $http({
    url: 'app/dns/get/batch/log/list',
    method: 'post',
    data
  })
}
...
export function getBatchLogDetail(params) {
  return $http({
    url: 'app/dns/getBatLogResultDetail',
    method: 'get',
    params
  })
}
