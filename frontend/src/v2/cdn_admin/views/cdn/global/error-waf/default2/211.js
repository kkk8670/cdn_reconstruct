...
<head>
  ...
  <style>
    ...
    .button:hover {
      box-shadow: -1px 2px 15px rgba(252, 84, 49, 0.2);
    }
  ...
  <div class="main" id="main" style="">
    ...
    <div class="container">
      ...
      <div class="network-check">
        <div class="network-check-status" id="loading">
          <svg t="1717595037717" class="loading-icon" viewBox="0 0 1024 1024" version="1.1"
            xmlns="http://www.w3.org/2000/svg" p-id="3052" id="mx_n_1717595037719" width="32" height="32">
            <path
        ...
        <div class="network-check-status hidden" id="success">
          <svg t="1717594741145" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
            p-id="1501" width="26" height="26">
            <path
              d="M512.564498 13.54796c-276.60419 0-500.710033 224.105843-500.710033 500.710033s224.105843 500.710033 500.710033 500.710033 500.145535-224.105843 500.145535-500.710033S788.60419 13.54796 512.564498 13.54796zM789.168688 447.647189C632.802646 536.837927 476.436604 790.297685 476.436604 790.297685c-134.350606-164.269019-241.040794-197.574421-241.040794-197.574421l134.350606-77.900772c63.223815 60.401323 106.690187 103.867696 106.690187 103.867696 176.123484-336.441014 312.732084-379.907387 312.732084-379.907387L789.168688 447.647189z"
              fill="#38c841" p-id="1502"></path>
          </svg>
          <span style="padding-left: 10px;">
            网络状态良好，欢迎继续访问！
          </span>
      ...
      <div class="handle">
        ...
        <button class="button hidden" id="verify" onclick="verify_func()">
          点击继续访问
        </button>
      </div>
    </div>
