    ...
    >
      ...
      <ants-form-item label="选择套餐" prop="serialNumber">
        <QueryPlanSelect
          ...
          v-if="!form.id"
        />
        <ants-input v-model="form.plan" disabled v-else />
      </ants-form-item>
      ...
      <ants-form-item class="ants-table_form_error" style="margin:0">
        <ants-form :model="tableForm" :rules="rules" ref="tableFormRef">
          ...
          >
            ...
            <ants-table-column label="回源端口" min-width="120">
              <template #default="{ row, $index }">
                <ants-form-item
...
<script>
import { doCreateUpdateStream } from '@/v2/cdn_admin/api/cdn/stream'
