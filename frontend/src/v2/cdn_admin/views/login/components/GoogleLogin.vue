<template>
  <div>
    <div
      class="flex items-center justify-center mb-xl cursor-pointer text-ants-text-3"
    >
      <svg
        t="1719982177961"
    ...
    >
      <!-- <div class="font-bold text-center">
        {{ antsT('请打开【Authenticator】查看动态验证码') }}
      </div> -->
...
<script>
import { googleLogin } from '@/v2/cdn_admin/api/login'
